// Program to implement Rock Paper Scissor Game in JavaScript
...
console.log("Hello "+ playerName  + " Well come the the Game");
...
if (playerMove == randomMoveOfComputer){
   ...
   console.log(playerName+" Won the match" + emoji);
}
